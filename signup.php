...
$checkemail = "SELECT * FROM users WHERE email = '$email'";
    ...
    echo  "<center><font color='red'>Email is already taken! try a different one</font></center>";
      ...
      if (mysqli_affected_rows($conn) > 0) { 
        echo "<script>alert('Successfully Registertd');
...
<div class="container">
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input id="name" name="name" placeholder="Enter Full Name" required="" tabindex="1" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['name']; } ?>"> 
          ...
          <input type="password" id="repassword" name="repassword" required=""> 
            ...
            <option value="FYBBA[CA]">FYBBA[CA]</option>
            <option value="SYBBA[CA]">SYBBA[CA]</option>
            <option value="TYBBA[CA]">TYBBA[CA]</option>
            </select><br><br>
